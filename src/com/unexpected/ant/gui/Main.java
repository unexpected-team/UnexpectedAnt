...
public class Main {
	public static void main(String[] args) {
		...
		GameEngine.INSTANCE.getGameField().getCells().get(0).addEntity(new Ant(Direction.SOUTHWEST));
		GameEngine.INSTANCE.getGameField().getCells().get(1).addEntity(new Ant(Direction.SOUTH));
